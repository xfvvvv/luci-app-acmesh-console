...
require_text "const owner = input(existing.owner || '', 'root');"
require_text "const group = input(existing.group || '', 'sing-box');"
require_text "const mode = input(existing.mode || '', '0640');"
